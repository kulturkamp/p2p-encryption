...
class RSA:
    def __init__(self, chatApp, k_length=1024):
        self.key_length = k_length
        self.chatApp = chatApp

        self.chatApp.sysMsg('Generating keypairs...')
    ...
    def oaep_encrypt(self, plaintext, pub_key=None, g=512, h=512):
    ...
    def oaep_decrypt(self, ciphertext, priv_key=None, g=512, h=512):
